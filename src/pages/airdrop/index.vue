<template>
    <div class="text-3xl font-bold">Airdrop (Mass Uniq Mint)</div>
    <br />
                ...
                <div class="grid gap-px grid-rows-1">
                    <span class="[font-family:'Inter-Regular',Helvetica] text-[#f9d198]">
                        ...
                        <p>
                            ...
                            header. Duplicate receiver accounts / factories are allowed.
                        </p>
                    </span>
                </div>
                <div class="grid gap-px grid-rows-1">
                    <pre>
<b>account,factory_id</b>
ab1bc2cd3de4,123
ab1bc2cd3de4,234
bb1cc2dd3ee4,420
</pre>
                ...
                <div class="grid grid-rows-1 gap-4">
                    ...
                    <div class="grid grid-cols-3 gap-4 py-4">
                        ...
                        <Button :disabled="userActions.length == 0" @onClick="emits('transact', userActions)">{{
                            userActions.length ? `Mint ${dataRows.length} Uniqs` : 'Mint'
                        }}</Button>
                    </div>
                </div>
            </div>
        ...
        return {
            ...
            data: {
                issue: {
                    ...
                    token_configs: [
                        {
                            token_factory_id: row.factory_id,
                            amount: 1,
                            custom_data: '',
                        },
                    ],
