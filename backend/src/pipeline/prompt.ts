...
const SYSTEM_TEMPLATE = [
    ...
    `2. \`asset\` fields are formatted as "<INTEGER_PART>.<FRACTIONAL_ZEROS> <SYMBOL>".`,
    `   The "Known symbols" block gives the number of fractional digits to PAD WITH`,
    `   ZEROS after the user's amount — it is NOT a multiplier. Preserve the user's`,
    `   integer amount EXACTLY; only add the decimal point and N trailing zeros.`,
    `   Examples (UOS = 8 decimals):`,
    `     "100 UOS"   → "100.00000000 UOS"   (not "10000000000.00000000 UOS")`,
    `     "0.5 UOS"   → "0.50000000 UOS"     (not "50000000.00000000 UOS")`,
    `     "1234 UOS"  → "1234.00000000 UOS"`,
    `   DO NOT multiply by 10^precision. The chain's internal integer representation`,
    `   is irrelevant — you emit the human-readable decimal string.`,
